    ...
    <div class="player-detail-card">
      ...
      <div class="avatar-wrap">
        <div class="avatar-large">
          ${playerName.toLowerCase() === 'astarum' ? `<img src="file:///C:/Users/Diego/Downloads/1f05e6cb522cc355812f8f7c4685ea01.jpg" alt="${playerName}">` : '<div style="width:100%;height:100%;background:#223;>' + '</div>'}
        </div>
      </div>
      <h3>${playerName}</h3>
